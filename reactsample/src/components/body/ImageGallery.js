...
const ImageGallery = () => {
    ...
    return (
        <div className="gallery-container">
            ...
            <div className="media-scroller snaps-inline" ref={scrollContainerRef}>
                ...
                <div className="media-element">
                    ...
                    <p className="title">Cillum dolore eu</p>
                </div>
                <div className="media-element">
                ...
                <div className="media-element">
                    ...
                    <p className="title">At lectus urnaVestibulum</p>
                </div>
                <div className="media-element">
                    ...
                    <p className="title">Vestibulum</p>
                </div>
                <div className="media-element">
                    ...
                    <p className="title">Adipiscing tristique risus nec feugiat</p>
                </div>
                <div className="media-element">
                    ...
                    <p className="title">Rutrum tellus pellentesque eu tincidunt</p>
                </div>
                <div className="media-element">
                    ...
                    <p className="title">Bibendum enim</p>
                </div>
                <div className="media-element">
                    ...
                    <p className="title">Amet commodo</p>
                </div>
                <div className="media-element">
                    ...
                    <p className="title">A erat nam at lectus</p>
                </div>
                <div className="media-element">
                    ...
                    <p className="title">Pellentesque eu tincidunt tortor aliquam nulla</p>
                </div>
                <div className="media-element">
                    ...
                    <p className="title">Quam adipiscing vitae</p>
                </div>
                <div className="media-element">
